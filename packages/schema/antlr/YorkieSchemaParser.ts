...
export class YorkieSchemaParser extends Parser {
  ...
  public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(
    YorkieSchemaParser._LITERAL_NAMES,
    YorkieSchemaParser._SYMBOLIC_NAMES,
    [],
  );
  ...
  public get ruleNames(): Array<string> {
    return YorkieSchemaParser.ruleNames;
  }

  // @Override
  public get serializedATN(): string {
    return YorkieSchemaParser._serializedATN;
  }
  ...
  public document(): DocumentContext {
    const _localctx: DocumentContext = new DocumentContext(
      this._ctx,
      this.state,
    );
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        while (
          _la === YorkieSchemaParser.T__0 ||
          _la === YorkieSchemaParser.T__3
        ) {
          {
            {
              this.state = 44;
  ...
  public typeAliasDeclaration(): TypeAliasDeclarationContext {
    const _localctx: TypeAliasDeclarationContext =
      new TypeAliasDeclarationContext(this._ctx, this.state);
  ...
  public variableDeclaration(): VariableDeclarationContext {
    const _localctx: VariableDeclarationContext =
      new VariableDeclarationContext(this._ctx, this.state);
  ...
  public unionType(): UnionTypeContext {
    const _localctx: UnionTypeContext = new UnionTypeContext(
      this._ctx,
      this.state,
    );
  ...
  public intersectionType(): IntersectionTypeContext {
    const _localctx: IntersectionTypeContext = new IntersectionTypeContext(
      this._ctx,
      this.state,
    );
  ...
  public primaryType(): PrimaryTypeContext {
    const _localctx: PrimaryTypeContext = new PrimaryTypeContext(
      this._ctx,
      this.state,
    );
  ...
  public primitiveType(): PrimitiveTypeContext {
    const _localctx: PrimitiveTypeContext = new PrimitiveTypeContext(
      this._ctx,
      this.state,
    );
      ...
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          !(
            (_la & ~0x1f) === 0 &&
            ((1 << _la) &
              ((1 << YorkieSchemaParser.T__10) |
                (1 << YorkieSchemaParser.T__11) |
                (1 << YorkieSchemaParser.T__12) |
                (1 << YorkieSchemaParser.T__13) |
                (1 << YorkieSchemaParser.T__14) |
                (1 << YorkieSchemaParser.T__15) |
                (1 << YorkieSchemaParser.T__16))) !==
              0
          )
        ) {
  ...
  public objectType(): ObjectTypeContext {
    const _localctx: ObjectTypeContext = new ObjectTypeContext(
      this._ctx,
      this.state,
    );
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        _la = this._input.LA(1);
        while (
          _la === YorkieSchemaParser.Identifier ||
          _la === YorkieSchemaParser.StringLiteral
        ) {
          {
            {
              this.state = 120;
  ...
  public propertySignature(): PropertySignatureContext {
    const _localctx: PropertySignatureContext = new PropertySignatureContext(
      this._ctx,
      this.state,
    );
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === YorkieSchemaParser.T__19) {
          {
            this.state = 129;
  ...
  public yorkieType(): YorkieTypeContext {
    const _localctx: YorkieTypeContext = new YorkieTypeContext(
      this._ctx,
      this.state,
    );
  ...
  public typeReference(): TypeReferenceContext {
    const _localctx: TypeReferenceContext = new TypeReferenceContext(
      this._ctx,
      this.state,
    );
  ...
  public parenthesizedType(): ParenthesizedTypeContext {
    const _localctx: ParenthesizedTypeContext = new ParenthesizedTypeContext(
      this._ctx,
      this.state,
    );
  ...
  public typeParameters(): TypeParametersContext {
    const _localctx: TypeParametersContext = new TypeParametersContext(
      this._ctx,
      this.state,
    );
  ...
  public typeParameter(): TypeParameterContext {
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === YorkieSchemaParser.T__30) {
          {
            this.state = 175;
  ...
  public typeArguments(): TypeArgumentsContext {
    const _localctx: TypeArgumentsContext = new TypeArgumentsContext(
      this._ctx,
      this.state,
    );
      ...
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          !(
            ((_la - 33) & ~0x1f) === 0 &&
            ((1 << (_la - 33)) &
              ((1 << (YorkieSchemaParser.StringLiteral - 33)) |
                (1 << (YorkieSchemaParser.NumberLiteral - 33)) |
                (1 << (YorkieSchemaParser.BooleanLiteral - 33)))) !==
              0
          )
        ) {
          this._errHandler.recoverInline(this);
  ...
  public static readonly _serializedATN: string =
    ...
    '$\x02&\x02(\x02*\x02,\x02\x02\x05\x03\x02\r\x13\x03\x02"#\x03\x02#%\x02' +
    ...
    '\x14\x02\x02z|\x05\x1A\x0E\x02{z\x03\x02\x02\x02|\x7F\x03\x02\x02\x02' +
    '}{\x03\x02\x02\x02}~\x03\x02\x02\x02~\x80\x03\x02\x02\x02\x7F}\x03\x02' +
    '\x02\x02\x80\x81\x07\x15\x02\x02\x81\x19\x03\x02\x02\x02\x82\x84\x05\x1C' +
    '\x0F\x02\x83\x85\x07\x16\x02\x02\x84\x83\x03\x02\x02\x02\x84\x85\x03\x02' +
    ...
    '\x02\x02\x8B\x8C\x07\x17\x02\x02\x8C\x9C\x05(\x15\x02\x8D\x8E\x07\x18' +
    '\x02\x02\x8E\x9C\x05(\x15\x02\x8F\x91\x07\x19\x02\x02\x90\x92\x05(\x15' +
    '\x02\x91\x90\x03\x02\x02\x02\x91\x92\x03\x02\x02\x02\x92\x9C\x03\x02\x02' +
    '\x02\x93\x95\x07\x1A\x02\x02\x94\x96\x05(\x15\x02\x95\x94\x03\x02\x02' +
    '\x02\x95\x96\x03\x02\x02\x02\x96\x9C\x03\x02\x02\x02\x97\x99\x07\x1B\x02' +
    ...
    '\xA1\xA2\x07\x1C\x02\x02\xA2\xA3\x05\f\x07\x02\xA3\xA4\x07\x1D\x02\x02' +
    '\xA4#\x03\x02\x02\x02\xA5\xA6\x07\x1E\x02\x02\xA6\xAB\x05&\x14\x02\xA7' +
    '\xA8\x07\x1F\x02\x02\xA8\xAA\x05&\x14\x02\xA9\xA7\x03\x02\x02\x02\xAA' +
    '\xAD\x03\x02\x02\x02\xAB\xA9\x03\x02\x02\x02\xAB\xAC\x03\x02\x02\x02\xAC' +
    '\xAE\x03\x02\x02\x02\xAD\xAB\x03\x02\x02\x02\xAE\xAF\x07 \x02\x02\xAF' +
    '%\x03\x02\x02\x02\xB0\xB3\x07"\x02\x02\xB1\xB2\x07!\x02\x02\xB2\xB4\x05' +
    "\f\x07\x02\xB3\xB1\x03\x02\x02\x02\xB3\xB4\x03\x02\x02\x02\xB4'\x03\x02" +
    '\x02\x02\xB5\xB6\x07\x1E\x02\x02\xB6\xBB\x05\f\x07\x02\xB7\xB8\x07\x1F' +
    '\x02\x02\xB8\xBA\x05\f\x07\x02\xB9\xB7\x03\x02\x02\x02\xBA\xBD\x03\x02' +
    '\x02\x02\xBB\xB9\x03\x02\x02\x02\xBB\xBC\x03\x02\x02\x02\xBC\xBE\x03\x02' +
    '\x02\x02\xBD\xBB\x03\x02\x02\x02\xBE\xBF\x07 \x02\x02\xBF)\x03\x02\x02' +
    '\x02\xC0\xC3\x07"\x02\x02\xC1\xC3\x05,\x17\x02\xC2\xC0\x03\x02\x02\x02' +
    '\xC2\xC1\x03\x02\x02\x02\xC3+\x03\x02\x02\x02\xC4\xC5\t\x04\x02\x02\xC5' +
    '-\x03\x02\x02\x02\x1718=FJX`hmu}\x84\x91\x95\x99\x9B\x9F\xAB\xB3\xBB\xC2';
  public static __ATN: ATN;
  public static get _ATN(): ATN {
    if (!YorkieSchemaParser.__ATN) {
      YorkieSchemaParser.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(YorkieSchemaParser._serializedATN),
      );
    }
...
export class DocumentContext extends ParserRuleContext {
  public EOF(): TerminalNode {
    return this.getToken(YorkieSchemaParser.EOF, 0);
  }
  public declaration(): Array<DeclarationContext>;
  public declaration(i: number): DeclarationContext;
  public declaration(
    i?: number,
  ): DeclarationContext | Array<DeclarationContext> {
    if (i === undefined) {
  ...
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_document;
  }
  // @Override
...
export class DeclarationContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_declaration;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class TypeAliasDeclarationContext extends ParserRuleContext {
  public Identifier(): TerminalNode {
    return this.getToken(YorkieSchemaParser.Identifier, 0);
  }
  public type(): TypeContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_typeAliasDeclaration;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class VariableDeclarationContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_variableDeclaration;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class TypeAnnotationContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_typeAnnotation;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class TypeContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_type;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class UnionTypeContext extends ParserRuleContext {
  public intersectionType(): Array<IntersectionTypeContext>;
  public intersectionType(i: number): IntersectionTypeContext;
  public intersectionType(
    i?: number,
  ): IntersectionTypeContext | Array<IntersectionTypeContext> {
    if (i === undefined) {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_unionType;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class IntersectionTypeContext extends ParserRuleContext {
  public arrayType(): Array<ArrayTypeContext>;
  public arrayType(i: number): ArrayTypeContext;
  public arrayType(i?: number): ArrayTypeContext | Array<ArrayTypeContext> {
    if (i === undefined) {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_intersectionType;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class ArrayTypeContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_arrayType;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class PrimaryTypeContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_primaryType;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class PrimitiveTypeContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_primitiveType;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class ObjectTypeContext extends ParserRuleContext {
  public propertySignature(): Array<PropertySignatureContext>;
  public propertySignature(i: number): PropertySignatureContext;
  public propertySignature(
    i?: number,
  ): PropertySignatureContext | Array<PropertySignatureContext> {
    if (i === undefined) {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_objectType;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class PropertySignatureContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_propertySignature;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class PropertyNameContext extends ParserRuleContext {
  public Identifier(): TerminalNode | undefined {
    return this.tryGetToken(YorkieSchemaParser.Identifier, 0);
  }
  public StringLiteral(): TerminalNode | undefined {
    return this.tryGetToken(YorkieSchemaParser.StringLiteral, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_propertyName;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class YorkieTypeContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_yorkieType;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class TypeReferenceContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_typeReference;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class ParenthesizedTypeContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_parenthesizedType;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class TypeParametersContext extends ParserRuleContext {
  public typeParameter(): Array<TypeParameterContext>;
  public typeParameter(i: number): TypeParameterContext;
  public typeParameter(
    i?: number,
  ): TypeParameterContext | Array<TypeParameterContext> {
    if (i === undefined) {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_typeParameters;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class TypeParameterContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_typeParameter;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class TypeArgumentsContext extends ParserRuleContext {
  public type(): Array<TypeContext>;
  public type(i: number): TypeContext;
  public type(i?: number): TypeContext | Array<TypeContext> {
    if (i === undefined) {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_typeArguments;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class ExpressionContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_expression;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
...
export class LiteralContext extends ParserRuleContext {
  ...
  public NumberLiteral(): TerminalNode | undefined {
    return this.tryGetToken(YorkieSchemaParser.NumberLiteral, 0);
  }
  public BooleanLiteral(): TerminalNode | undefined {
    return this.tryGetToken(YorkieSchemaParser.BooleanLiteral, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return YorkieSchemaParser.RULE_literal;
  }
  // @Override
  public enterRule(listener: YorkieSchemaListener): void {
