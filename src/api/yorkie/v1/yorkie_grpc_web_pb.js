 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.yorkie.v1.BroadcastRequest,
 *   !proto.yorkie.v1.BroadcastResponse>}
 */
const methodDescriptor_YorkieService_Broadcast = new grpc.web.MethodDescriptor(
  '/yorkie.v1.YorkieService/Broadcast',
  grpc.web.MethodType.UNARY,
  proto.yorkie.v1.BroadcastRequest,
  proto.yorkie.v1.BroadcastResponse,
  /**
   * @param {!proto.yorkie.v1.BroadcastRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.yorkie.v1.BroadcastRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.yorkie.v1.BroadcastResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.yorkie.v1.BroadcastResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.yorkie.v1.YorkieServiceClient.prototype.broadcast =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/yorkie.v1.YorkieService/Broadcast',
      request,
      metadata || {},
      methodDescriptor_YorkieService_Broadcast,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.yorkie.v1.BroadcastResponse>}
 *     Promise that resolves to the response
 */
proto.yorkie.v1.YorkieServicePromiseClient.prototype.broadcast =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/yorkie.v1.YorkieService/Broadcast',
      request,
