...
export class YorkieServiceClient {
  ...
  deactivateClient(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: yorkie_v1_yorkie_pb.DeactivateClientResponse,
    ) => void,
  ...
  updatePresence(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: yorkie_v1_yorkie_pb.UpdatePresenceResponse,
    ) => void,
  ...
  attachDocument(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: yorkie_v1_yorkie_pb.AttachDocumentResponse,
    ) => void,
  ...
  detachDocument(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: yorkie_v1_yorkie_pb.DetachDocumentResponse,
    ) => void,
  ...
  pushPull(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: yorkie_v1_yorkie_pb.PushPullResponse,
    ) => void,
