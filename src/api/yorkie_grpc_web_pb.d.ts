...
import * as src_api_yorkie_pb from '@yorkie-js-sdk/src/api/yorkie_pb';
...
export class YorkieClient {
  ...
  activateClient(
    ...
    callback: (
      err: grpcWeb.Error,
      response: src_api_yorkie_pb.ActivateClientResponse,
    ) => void,
  ...
  deactivateClient(
    ...
    callback: (
      err: grpcWeb.Error,
      response: src_api_yorkie_pb.DeactivateClientResponse,
    ) => void,
  ...
  attachDocument(
    ...
    callback: (
      err: grpcWeb.Error,
      response: src_api_yorkie_pb.AttachDocumentResponse,
    ) => void,
  ...
  detachDocument(
    ...
    callback: (
      err: grpcWeb.Error,
      response: src_api_yorkie_pb.DetachDocumentResponse,
    ) => void,
  ...
  pushPull(
    ...
    callback: (
      err: grpcWeb.Error,
      response: src_api_yorkie_pb.PushPullResponse,
    ) => void,
...
export class ClusterClient {
  ...
  broadcastEvent(
    ...
    callback: (
      err: grpcWeb.Error,
      response: src_api_yorkie_pb.BroadcastEventResponse,
    ) => void,
