 ...
 * @const
 */
proto.api.WatchDocumentsRequest.repeatedFields_ = [4];
...
proto.api.WatchDocumentsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    header: (f = msg.getHeader()) && proto.api.RequestHeader.toObject(includeInstance, f),
    clientId: jspb.Message.getFieldWithDefault(msg, 2, ""),
    clientMetaMap: (f = msg.getClientMetaMap()) ? f.toObject(includeInstance, undefined) : [],
...
proto.api.WatchDocumentsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = msg.getClientMetaMap();
...
proto.api.WatchDocumentsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getClientMetaMap(true);
  if (f && f.getLength() > 0) {
 ...
 */
proto.api.WatchDocumentsRequest.prototype.getClientMetaMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.api.WatchDocumentsRequest} returns this
 */
proto.api.WatchDocumentsRequest.prototype.clearClientMetaMap = function() {
  this.getClientMetaMap().clear();
  return this;};
...
proto.api.WatchDocumentsRequest.prototype.getDocumentKeysList = function() {
  return /** @type{!Array<!proto.api.DocumentKey>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.api.DocumentKey, 4));
};
...
proto.api.WatchDocumentsRequest.prototype.addDocumentKeys = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.api.DocumentKey, opt_index);
};
 ...
 * @return {string}
 */
proto.api.Client.prototype.getClientId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.api.Client.prototype.setClientId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.api.Client.prototype.getClientMetaMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
 ...
 * @return {!proto.api.Client} returns this
 */
proto.api.Client.prototype.clearClientMetaMap = function() {
  this.getClientMetaMap().clear();
  return this;};
 ...
 * @const
 */
proto.api.WatchDocumentsResponse.Event.repeatedFields_ = [4];
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.api.WatchDocumentsResponse.Event.prototype.getClientMetaMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
      jspb.Message.getMapField(this, 2, opt_noLazyCreate,
      null));
};
 ...
 * @return {!proto.api.WatchDocumentsResponse.Event} returns this
 */
proto.api.WatchDocumentsResponse.Event.prototype.clearClientMetaMap = function() {
  this.getClientMetaMap().clear();
  return this;};
