 ...
 */
export class RemoveAttributeOperation extends Operation {
  ...
  /**
   * `create` creates a new instance of RemoveAttributeOperation.
   */
  public static create(
    ...
    return new RemoveAttributeOperation(parentCreatedAt, createdAt, executedAt);
  }
  ...
  public execute(root: CRDTRoot): void {
    ...
    if (parentObject instanceof CRDTTreeNode) {
      ...
      const elem = obj.removeAttribute(this.createdAt, this.getExecutedAt());
