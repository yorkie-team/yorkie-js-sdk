      ...
      <Router>
        <div className="app-container">
          <Routes>
            <Route 
              path="/" 
              element={<PostListWithApi currentUser={currentUser} samplePosts={samplePosts} />} 
            />
            <Route 
              path="/post/:id" 
