# Yorkie React Watch This Page Example

<p>
    <a href="https://yorkie.dev/yorkie-js-sdk/examples/react-watch-this-page/" target="_blank">
...
<img width="500" alt="Watch This Page" src="thumbnail.png"/>
...
```bash
# In the root directory of the repository.
$ pnpm react-watch-this-page dev
